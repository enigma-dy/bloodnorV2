...
rt(Jl, {
  ...
  Extensions: () => Cr,
  MetricsClient: () => Ye,
  InitializationError: () => I,
  KnownRequestError: () => X,
  RustPanicError: () => we,
  UnknownRequestError: () => j,
  ValidationError: () => W,
  Public: () => Rr,
  Sql: () => Z,
  createParam: () => Ri,
...
var we = class extends Error {
  clientVersion;
  constructor(e, r) {
    super(e), (this.name = 'RustPanicError'), (this.clientVersion = r);
  }
  get [Symbol.toStringTag]() {
    return 'RustPanicError';
  }
};
te(we, 'RustPanicError');
u();
c();
m();
p();
...
var tn,
  yo = {
    async loadLibrary(t) {
      ...
      if (r === void 0)
        throw new I(
          `The \`adapter\` option for \`\` is required in this context (${Re().prettyName})`,
          e,
        );
      if (n === void 0)
  ...
  pr = class {
    constructor(e) {
      ...
      (this.resolveDatasourceUrl =
        ...
        (this.UnknownRequestError =
          this.config.accelerateUtils?.UnknownRequestError),
        (this.InitializationError =
          this.config.accelerateUtils?.InitializationError),
        (this.KnownRequestError =
          this.config.accelerateUtils?.KnownRequestError),
...
`),
  ...
  {
    let T = [
      ` failed to initialize because it wasn't configured to run in this environment (${Re().prettyName}).`,
...
Read more at https://pris.ly/d/client-constructor`,
      ...
      (this.name = 'ConstructorValidationError');
  }
  get [Symbol.toStringTag]() {
    return 'ConstructorValidationError';
  }
};
te(D, 'ConstructorValidationError');
var No = [
    'datasources',
    'datasourceUrl',
    'errorFormat',
    ...
    datasources: (t, { datasourceNames: e }) => {
      if (t) {
        if (typeof t != 'object' || Array.isArray(t))
          throw new D(
            `Invalid value ${JSON.stringify(t)} for "datasources" provided to  constructor`,
          );
        for (let [r, n] of Object.entries(t)) {
          if (!e.includes(r)) {
            let i = tt(r, e) || ` Available datasources: ${e.join(', ')}`;
            throw new D(
              `Unknown datasource ${r} provided to  constructor.${i}`,
            );
          }
          if (typeof n != 'object' || Array.isArray(n))
            throw new D(`Invalid value ${JSON.stringify(t)} for datasource "${r}" provided to  constructor.
...
It should have this form: { url: "CONNECTION_STRING" }`);
              if (typeof o != 'string')
                throw new D(`Invalid value ${JSON.stringify(o)} for datasource "${r}" provided to  constructor.
It should have this form: { url: "CONNECTION_STRING" }`);
            }
        }
      }
    ...
    adapter: (t, e) => {
      if (!t && Ue(e.generator) === 'client')
        throw new D(
          'Using engine type "client" requires a driver adapter to be provided to  constructor.',
        );
      if (t === null) return;
      if (t === void 0)
        throw new D(
      ...
      if (!dr(e).includes('driverAdapters'))
        throw new D(
          '"adapter" property can only be provided to  constructor when "driverAdapters" preview feature is enabled.',
        );
    ...
    datasourceUrl: (t) => {
      if (typeof t < 'u' && typeof t != 'string')
        throw new D(`Invalid value ${JSON.stringify(t)} for "datasourceUrl" provided to  constructor.
Expected string or undefined.`);
    ...
    errorFormat: (t) => {
      if (t) {
        if (typeof t != 'string')
          throw new D(
            `Invalid value ${JSON.stringify(t)} for "errorFormat" provided to  constructor.`,
          );
        if (!qo.includes(t)) {
          let e = tt(t, qo);
          throw new D(`Invalid errorFormat ${t} provided to  constructor.${e}`);
        }
      }
    },
    log: (t) => {
      ...
      if (!Array.isArray(t))
        throw new D(
          `Invalid value ${JSON.stringify(t)} for "log" provided to  constructor.`,
        );
      function e(r) {
        if (typeof r == 'string' && !Uo.includes(r)) {
          let n = tt(r, Uo);
          throw new D(`Invalid log level "${r}" provided to  constructor.${n}`);
        }
      }
      for (let r of t) {
        e(r);
        let n = {
          ...
          emit: (i) => {
            ...
            if (!o.includes(i)) {
              let s = tt(i, o);
              throw new D(
                `Invalid value ${JSON.stringify(i)} for "emit" in logLevel provided to  constructor.${s}`,
              );
            }
          },
        };
        if (r && typeof r == 'object')
          for (let [i, o] of Object.entries(r))
            if (n[i]) n[i](o);
              ...
              throw new D(
                `Invalid property ${i} for "log" provided to  constructor`,
              );
      }
    },
    transactionOptions: (t) => {
      ...
      if (e != null && e <= 0)
        throw new D(
          `Invalid value ${e} for maxWait in "transactionOptions" provided to  constructor. maxWait needs to be greater than 0`,
        );
      let r = t.timeout;
      if (r != null && r <= 0)
        throw new D(
          `Invalid value ${r} for timeout in "transactionOptions" provided to  constructor. timeout needs to be greater than 0`,
        );
    },
    omit: (t, e) => {
      if (typeof t != 'object')
    ...
    __internal: (t) => {
      ...
      if (typeof t != 'object')
        throw new D(
          `Invalid value ${JSON.stringify(t)} for "__internal" to  constructor`,
        );
      for (let [r] of Object.entries(t))
        if (!e.includes(r)) {
          let n = tt(r, e);
          throw new D(
            `Invalid property ${JSON.stringify(r)} for "__internal" provided to  constructor.${n}`,
          );
        }
    },
  };
function Vo(t, e) {
  for (let [r, n] of Object.entries(t)) {
    if (!No.includes(r)) {
      let i = tt(r, No);
      throw new D(`Unknown property ${r} provided to  constructor.${i}`);
    }
    Fl[r](n, e);
  }
